...
WebUI.click(findTestObject('Component Master/Click_add New Component button'))

WebUI.setText(findTestObject('Component Master/setText_Code'), findTestData('Component Master/Component').getValue(2, 1))

WebUI.setText(findTestObject('Component Master/SetText_Description'), findTestData('Component Master/Component').getValue(
        3, 1))

WebUI.click(findTestObject('Component Master/SetText_ISO Group'))

WebUI.sendKeys(findTestObject('Component Master/SetText_ISO Group'), findTestData('Component Master/Component').getValue(
        4, 1))

WebUI.sendKeys(findTestObject('Component Master/SetText_ISO Group'), Keys.chord(Keys.TAB))

WebUI.click(findTestObject('Component Master/Click_Business Partner'))

WebUI.sendKeys(findTestObject('Component Master/Click_Business Partner'), findTestData('Component Master/Component').getValue(
        5, 1))

WebUI.sendKeys(findTestObject('Component Master/Click_Business Partner'), Keys.chord(Keys.TAB))
