...
WebUI.setText(findTestObject('IMO Class/SetText_Search'), findTestData('IMO Class/Imo Class').getValue(2, 1))

WebUI.click(findTestObject('IMO Class/click_selected record'))

WebUI.setText(findTestObject('IMO Class/SetText_Imo Class Code'), findTestData('IMO Class/Imo Class').getValue(2, 2))

WebUI.setText(findTestObject('IMO Class/Imo Class Description'), findTestData('IMO Class/Imo Class').getValue(3, 2))
