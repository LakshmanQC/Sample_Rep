...
WebUI.setText(findTestObject('IMO Class/SetText_Imo Class Code'), findTestData('IMO Class/Imo Class').getValue(2, 1))

WebUI.setText(findTestObject('IMO Class/Imo Class Description'), findTestData('IMO Class/Imo Class').getValue(3, 1))
