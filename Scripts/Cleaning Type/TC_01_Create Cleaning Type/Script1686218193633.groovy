...
WebUI.setText(findTestObject('Cleaning Type/SetText_CodeCleaning Type'), findTestData('Cleaning Type').getValue(2, 1))

WebUI.setText(findTestObject('Cleaning Type/SetText_Description'), findTestData('Cleaning Type').getValue(3, 1))
